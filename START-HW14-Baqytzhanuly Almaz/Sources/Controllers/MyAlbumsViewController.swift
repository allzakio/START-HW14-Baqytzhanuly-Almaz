...
//    MARK: - Setups
    ...
    private func setupCells() {
        ...
        [SectionModel(image: UIImage(named: "toyota"), title: "Недавние", imageCount: "1830"),
        SectionModel(image: UIImage(named: "mercedes"), title: "Избранное", imageCount: "9"),
        SectionModel(image: UIImage(named: "kia"), title: "Kia", imageCount: "45"),
        SectionModel(image: UIImage(named: "hyundai"), title: "Hyundai", imageCount: "20"),
        SectionModel(image: UIImage(named: "bmw"), title: "BMW", imageCount: "2")
        ],
        [SectionModel(image: UIImage(named: "peoples"), title: "Люди", imageCount: "21"),
        SectionModel(image: UIImage(named: "paris"), title: "Места", imageCount: "230")
        ],
